                ...
                <form _ngcontent-bis-c206 noValidate name="form" className="form rounded-section mx-auto mt-4 bg-white lg:w-5/12 overflow-hidden ng-pristine ng-invalid ng-touched">
                    ...
                    <div _ngcontent-bis-c206 className="p-4 md:p-8">
                            ...
                            <div className="mat-form-field-wrapper ng-tns-c144-14">
                                <div className="mat-form-field-flex ng-tns-c144-14">
                                    ...
                                    <div className="mat-form-field-infix ng-tns-c144-14">
                                        <LoginInput placeholder="Username" _ngcontent-bis-c206 matinput type="text" formcontrolname="username" name="username" className="mat-input-element mat-form-field-autofill-control ng-tns-c144-14 ng-pristine ng-invalid cdk-text-field-autofill-monitored ng-touched" id="mat-input-0" data-placeholder aria-invalid="false" aria-required="false" onChange={(e) => setUsername(e.target.value)} />
                                    </div>
                                    {/**/}
                                </div>
                            </div>
                        ...
                        <mat-form-field _ngcontent-bis-c206 appearance="fill" floatlabel="always" className="mat-form-field w-full ng-tns-c144-14 mat-primary mat-form-field-type-mat-input mat-form-field-appearance-fill mat-form-field-can-float mat-form-field-should-float mat-form-field-has-label ng-pristine ng-invalid ng-touched" style={{ fontSize: '18px' }}>
                            <div className="mat-form-field-wrapper ng-tns-c144-14">
                                <div className="mat-form-field-flex ng-tns-c144-14">
                                    {/**/}{/**/}
                                    <div className="mat-form-field-infix ng-tns-c144-14">
                                        <LoginInput placeholder="Email" _ngcontent-bis-c206 matinput type="text" formcontrolname="username" name="username" className="mat-input-element mat-form-field-autofill-control ng-tns-c144-14 ng-pristine ng-invalid cdk-text-field-autofill-monitored ng-touched" id="mat-input-0" data-placeholder aria-invalid="false" aria-required="false" onChange={(e) => setEmail(e.target.value)} />
                                    </div>
                                    {/**/}
                                </div>
                            </div>
                        ...
                        <div _ngcontent-bis-c206 className="text-base mt-8 text-center">
                            <span _ngcontent-bis-c206>AlReady Have Acount? </span>
                            <Link to={"/login-user"} _ngcontent-bis-c206 queryparamshandling="merge" className="text-primary">Login Now !</Link>
                        </div>
                    </div>
                </form>
                {/* End Form Login */}
