        ...
        <NavbarContainer>
            ...
            {islogin === false && (
                <>
                    ...
                    {/* Right Mennu */}
                    <div className='flex items-center flex-row  mr-32'>

                        <button className="rounded-md bg-gray-200 hover:bg-gray-400 p-2 flex items-center mx-2">
                            <Link className="cursor-pointer font-bold flex px-4" to="/login-user">
                                <p className="text-gray-600 hover:text-white">Sign In</p>
                            </Link>
                        </button>
                        <button className="rounded-md bg-blue-300 hover:bg-blue-600 p-2 flex items-center">
                    ...
                    <div className='flex flex-row justify-end items-center mr-4'>
                        <button className='bg-blue-400 text-white p-2 hover:bg-blue-500 rounded-md'> Market Place</button>
                    </div>
                </>
            )}
        </NavbarContainer>
